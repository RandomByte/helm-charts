...
If release name contains chart name it will be used as a full name.
*/}}
{{- define "hercules.speedtest.fullname" -}}
{{- $name := default .Chart.Name .Values.nameOverride }}
{{- if contains $name .Release.Name }}
{{- printf "%s-%s" .Release.Name "speedtest" | trunc 63 | trimSuffix "-" }}
{{- else }}
{{- printf "%s-%s-%s" .Release.Name $name "speedtest" | trunc 63 | trimSuffix "-" }}
{{- end }}
{{- end }}
...
If release name contains chart name it will be used as a full name.
*/}}
{{- define "hercules.isponsorblocktv.fullname" -}}
{{- $name := default .Chart.Name .Values.nameOverride }}
{{- if contains $name .Release.Name }}
{{- printf "%s-%s" .Release.Name "isponsorblocktv" | trunc 63 | trimSuffix "-" }}
{{- else }}
{{- printf "%s-%s-%s" .Release.Name $name "isponsorblocktv" | trunc 63 | trimSuffix "-" }}
{{- end }}
{{- end }}
